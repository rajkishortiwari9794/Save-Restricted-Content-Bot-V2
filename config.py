...
BOT_TOKEN = getenv("BOT_TOKEN", "8656381064:AAGHEE_KTV4h6hPkPC1ISJxu8cirA-Nav3I")
OWNER_ID = list(map(int, getenv("OWNER_ID", "5716292248 7604081669 5648658139 7080075962").split()))
